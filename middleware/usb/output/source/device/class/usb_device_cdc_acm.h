 ...
 */
extern usb_status_t USB_DeviceCdcAcmSend(class_handle_t handle, uint8_t ep, uint8_t *buffer,
					 uint32_t length);
/*!
 ...
 * @note The function can only be called in the same context.
 */
extern usb_status_t USB_DeviceCdcAcmRecv(class_handle_t handle, uint8_t ep, uint8_t *buffer,
					 uint32_t length);
