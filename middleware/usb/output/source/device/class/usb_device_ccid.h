...
typedef struct _usb_device_ccid_set_parameters_t0_command
	usb_device_ccid_set_parameters_t0_command_t;
...
typedef struct _usb_device_ccid_set_parameters_t1_command
	usb_device_ccid_set_parameters_t1_command_t;
...
typedef struct _usb_device_ccid_secure_pin_operation_command
	usb_device_ccid_secure_pin_operation_command_t;
...
typedef struct _usb_device_ccid_seucre_pin_verification_command
	usb_device_ccid_seucre_pin_verification_command_t;
...
typedef struct _usb_device_ccid_secure_pin_modification_command
...
typedef struct _usb_device_ccid_notify_slot_chnage_notification
...
typedef struct _usb_device_ccid_hardware_error_notification
...
typedef struct _usb_device_ccid_struct {
	...
	uint8_t					slotsChangeBuffer[(USB_DEVICE_CONFIG_CCID_SLOT_MAX *
								   2 - 1U) / 8 + 1U +
								  1U]; /*!< The buffer for saving slot status */
	uint8_t					slotsSendingChangeBuffer[(
										 USB_DEVICE_CONFIG_CCID_SLOT_MAX
										 * 2 - 1U) / 8 +
									 1U +
 ...
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceCcidNotifySlotChange(class_handle_t handle, uint8_t slot,
 ...
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceCcidNotifyHardwareError(class_handle_t handle, uint8_t slot,
