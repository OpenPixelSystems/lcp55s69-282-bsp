...
typedef usb_status_t (*usb_device_class_callback_t)(class_handle_t classHandle, uint32_t
						    callbackEvent, void *eventParam);
...
typedef usb_status_t (*usb_device_class_init_call_t)(uint8_t
						     controllerId,
