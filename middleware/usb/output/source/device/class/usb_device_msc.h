...
typedef struct _usb_device_lba_information_struct {
	...
	usb_device_logical_unit_information_struct_t	logicalUnitInformations[
...
extern usb_status_t USB_DeviceMscLbaTransfer(usb_device_msc_struct_t *mscHandle, uint8_t direction,
