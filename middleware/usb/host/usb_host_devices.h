...
typedef struct _usb_host_device_instance {
	...
	uint8_t					interfaceStatus[
		USB_HOST_CONFIG_CONFIGURATION_MAX_INTERFACE];           /*!< Interfaces' status, please reference to
	                                                                 #usb_host_interface_state_t */
 ...
 */
extern usb_status_t USB_HostAttachDevice(usb_host_handle hostHandle, uint8_t speed, uint8_t
					 hubNumber, uint8_t portNumber, uint8_t level,
 ...
 * @return kStatus_USB_Success or error codes.
 */
extern usb_status_t USB_HostDetachDevice(usb_host_handle hostHandle, uint8_t hubNumber, uint8_t
					 portNumber);
 ...
 * @return kStatus_USB_Success or error codes.
 */
extern usb_status_t USB_HostDetachDeviceInternal(usb_host_handle hostHandle, usb_device_handle
						 deviceHandle);
 ...
 * @return kStatus_USB_Success or error codes.
 */
extern usb_status_t USB_HostValidateDevice(usb_host_handle hostHandle, usb_device_handle
					   deviceHandle);
