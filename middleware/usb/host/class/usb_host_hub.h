 ...
 */
extern usb_status_t USB_HostHubInit(usb_device_handle		deviceHandle,
 ...
 */
extern usb_status_t USB_HostHubDeinit(usb_device_handle deviceHandle, usb_host_class_handle
				      classHandle);
 ...
 */
extern usb_status_t USB_HostHubInterruptRecv(usb_host_class_handle classHandle, uint8_t *buffer,
					     uint16_t bufferLength, transfer_callback_t callbackFn,
					     void *callbackParam);
 ...
 *                                    Or, send transfer fail. See the USB_HostSendSetup.
 */
extern usb_status_t USB_HostHubGetDescriptor(usb_host_class_handle classHandle, uint8_t *buffer,
					     uint16_t bufferLength, transfer_callback_t callbackFn,
					     void *callbackParam);
 ...
 */
extern usb_status_t USB_HostHubClearFeature(usb_host_class_handle classHandle, uint8_t feature,
 ...
 *                                    Or, send transfer fail. See the USB_HostSendSetup.
 */
extern usb_status_t USB_HostHubGetStatus(usb_host_class_handle classHandle, uint8_t *buffer,
					 uint16_t bufferLength, transfer_callback_t callbackFn,
					 void *callbackParam);
 ...
 *                                    Or, send transfer fail. See the USB_HostSendSetup.
 */
extern usb_status_t USB_HostHubSetPortFeature(usb_host_class_handle classHandle, uint8_t portNumber,
					      uint8_t feature, transfer_callback_t callbackFn,
					      void *callbackParam);
 ...
 *                                    Or, send transfer fail. See the USB_HostSendSetup.
 */
extern usb_status_t USB_HostHubClearPortFeature(usb_host_class_handle classHandle, uint8_t
						portNumber, uint8_t feature, transfer_callback_t
 ...
 *                                    Or, send transfer fail. See the USB_HostSendSetup.
 */
extern usb_status_t USB_HostHubGetPortStatus(usb_host_class_handle classHandle, uint8_t portNumber,
