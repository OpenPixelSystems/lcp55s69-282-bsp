...
typedef struct _usb_audio_2_0_control_range_layout3_struct
	usb_audio_2_0_control_range_layout3_struct_t;
...
typedef struct _usb_audio_2_0_control_range_layout2_struct
 ...
 */
extern usb_status_t USB_HostAudioInit(usb_device_handle		deviceHandle,
 ...
 */
extern usb_status_t USB_HostAudioDeinit(usb_device_handle deviceHandle, usb_host_class_handle
					classHandle);
...
extern usb_status_t USB_HostAudioStreamSetInterface(usb_host_class_handle classHandle,
						    ...
						    uint8_t alternateSetting, transfer_callback_t
 ...
 */
extern uint16_t USB_HostAudioPacketSize(usb_host_class_handle classHandle, uint8_t pipeType, uint8_t
					direction);
 ...
 */
extern usb_status_t USB_HostAudioStreamRecv(usb_host_class_handle classHandle, uint8_t *buffer,
					    uint32_t bufferLen, transfer_callback_t callbackFn,
					    void *callbackParam);
 ...
 */
extern usb_status_t USB_HostAudioStreamSend(usb_host_class_handle classHandle, uint8_t *buffer,
					    uint32_t bufferLen, transfer_callback_t callbackFn,
					    void *callbackParam);
 ...
 *
 */
extern usb_status_t USB_HostAudioStreamGetCurrentAltsettingDescriptors(usb_host_class_handle
								       classHandle,
								       usb_audio_stream_spepific_as_intf_desc_t
								       **
								       asIntfDesc,
 ...
 *
 */
extern usb_status_t USB_HostAudioFeatureUnitRequest(usb_host_class_handle classHandle, uint8_t
						    channelNo, void *buf, uint32_t cmdCode,
 ...
 *
 */
extern usb_status_t USB_HostAudioEndpointRequest(usb_host_class_handle classHandle, void *buf,
						 uint32_t cmdCode, transfer_callback_t callbackFn,
						 void *callbackParam);
/*!
 ...
 *
 */
usb_status_t USB_HostAudioControlGetCurrentAltsettingSpecificDescriptors(usb_host_class_handle
									 classHandle, uint32_t
 ...
 *
 */
usb_status_t USB_HostAudioStreamGetCurrentAltsettingSpecificDescriptors(usb_host_class_handle
									classHandle, uint32_t
									DescriptorType, uint32_t
									DescriptorSubType,
									void **Descriptor);
 ...
 *
 */
usb_status_t USB_HostAudioGetSetFeatureUnitRequest(usb_host_class_handle classHandle, uint32_t
						   csAndCn, uint32_t cmdCode, void *buf, uint32_t
						   bufLen, transfer_callback_t callbackFn,
						   void *callbackParam);
 ...
 *
 */
usb_status_t USB_HostAudioGetSetClockSourceRequest(usb_host_class_handle classHandle, uint32_t
						   csAndCn, uint32_t cmdCode, void *buf, uint32_t
						   bufLen, transfer_callback_t callbackFn,
						   void *callbackParam);
/*!
 ...
 *
 */
usb_status_t USB_HostAudioGetSetEndpointRequest(usb_host_class_handle classHandle, uint32_t csAndCn,
						uint32_t cmdCode, void *buf, uint32_t bufLen,
						transfer_callback_t callbackFn,
						void *callbackParam);
