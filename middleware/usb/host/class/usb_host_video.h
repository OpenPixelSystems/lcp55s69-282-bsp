 ...
 */
usb_status_t USB_HosVideoStreamRecv(usb_host_class_handle classHandle, uint8_t *buffer, uint32_t
				    bufferLen, transfer_callback_t callbackFn, void *callbackParam);
 ...
 *
 */
usb_status_t USB_HostVideoStreamGetFormatDescriptor(usb_host_class_handle classHandle, uint8_t
						    subType, void **descriptor);
 ...
 *
 */
usb_status_t USB_HostVideoStreamGetFrameDescriptor(usb_host_class_handle classHandle,
						   void *formatDescriptor, uint8_t subType, uint8_t
 ...
 */
usb_status_t USB_HostVideoSetProbe(usb_host_class_handle classHandle, uint8_t request,
				   uint8_t *probe, transfer_callback_t callbackFn,
				   void *callbackParam);
 ...
 * @retval kStatus_USB_InvalidParameter  The interface descriptor is NULL pointer.
 */
usb_status_t USB_HostVideoGetProbe(usb_host_class_handle classHandle, uint8_t request,
				   uint8_t *probe, transfer_callback_t callbackFn,
				   void *callbackParam);
 ...
 */
usb_status_t USB_HostVideoGetCommit(usb_host_class_handle classHandle, uint8_t brequest,
				    uint8_t *probe, transfer_callback_t callbackFn,
				    void *callbackParam);
 ...
 * @retval kStatus_USB_InvalidParameter  The interface descriptor is NULL pointer.
 */
usb_status_t USB_HostVideoSetCommit(usb_host_class_handle classHandle, uint8_t brequest,
				    uint8_t *probe, transfer_callback_t callbackFn,
				    void *callbackParam);
/*! @}*/
