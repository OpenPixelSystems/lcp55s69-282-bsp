...
#define WM8960_IFACE1_DLRSWAP(x)    ((x << WM8960_IFACE1_DLRSWAP_SHIFT) & \
...
#define WM8960_IFACE1_BCLKINV(x)     ((x << WM8960_IFACE1_BCLKINV_SHIFT) & \
...
#define WM8960_IFACE1_ALRSWAP(x)    ((x << WM8960_IFACE1_ALRSWAP_SHIFT) & \
