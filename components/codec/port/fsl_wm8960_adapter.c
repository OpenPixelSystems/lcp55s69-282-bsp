...
#define HAL_WM8960_PLAY_CAPABILITY                                                                       \
	(kCODEC_SupportPlayChannelLeft0 | kCODEC_SupportPlayChannelRight0 | \
	 ...
	 kCODEC_SupportPlayChannelRight1 | kCODEC_SupportPlaySourcePGA | \
	 kCODEC_SupportPlaySourceDAC |       \
	 kCODEC_SupportPlaySourceInput)

#define HAL_WM8960_RECORD_CAPABILITY                                                                    \
	(kCODEC_SupportPlayChannelLeft0 | kCODEC_SupportPlayChannelLeft1 | \
	 kCODEC_SupportPlayChannelLeft2 | \
	 kCODEC_SupportPlayChannelRight0 | kCODEC_SupportPlayChannelRight1 | \
...
#define HAL_WM8960_MAP_PROTOCOL(protocol)       \
	(protocol == kCODEC_BusI2S ?                \
	 ...
	 protocol == kCODEC_BusPCMA ? kWM8960_BusPCMA : protocol == kCODEC_BusPCMB ? \
	 kWM8960_BusPCMB : kWM8960_BusI2S)
...
status_t HAL_CODEC_WM8960_Init(void *handle, void *config)
{
	...
	wm8960_handle_t *wm8960Handle =
		(wm8960_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle));
 ...
 */
status_t HAL_CODEC_WM8960_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t
				    bitWidth)
{
	assert(handle != NULL);

	return WM8960_ConfigDataFormat(
		(wm8960_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)), mclk,
		sampleRate, bitWidth);
}
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_WM8960_SetRecordChannel(void *handle, uint32_t leftRecordChannel, uint32_t
					   rightRecordChannel)
{
