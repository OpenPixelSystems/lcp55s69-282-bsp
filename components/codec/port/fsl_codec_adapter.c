...
#ifdef CODEC_WM8904_ENABLE
	case kCODEC_WM8904:
		retVal = HAL_CODEC_WM8904_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_WM8960_ENABLE
	case kCODEC_WM8960:
		retVal = HAL_CODEC_WM8960_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_WM8524_ENABLE
	case kCODEC_WM8524:
		retVal = HAL_CODEC_WM8524_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_SGTL5000_ENABLE
	case kCODEC_SGTL5000:
		retVal = HAL_CODEC_SGTL5000_SetRecordChannel(handle, leftRecordChannel,
							     rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_DA7212_ENABLE
	case kCODEC_DA7212:
		retVal = HAL_CODEC_DA7212_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_CS42888_ENABLE
	case kCODEC_CS42888:
		retVal = HAL_CODEC_CS42888_SetRecordChannel(handle, leftRecordChannel,
							    rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_AK4497_ENABLE
	case kCODEC_AK4497:
		retVal = HAL_CODEC_AK4497_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_AK4458_ENABLE
	case kCODEC_AK4458:
		retVal = HAL_CODEC_AK4458_SetRecordChannel(handle, leftRecordChannel,
							   rightRecordChannel);
		break;
#endif
...
#ifdef CODEC_TFA9XXX_ENABLE
	case kCODEC_TFA9XXX:
		retVal = HAL_CODEC_TFA9XXX_SetRecordChannel(handle, leftRecordChannel,
							    rightRecordChannel);
		break;
#endif
	default:
