...
static void HAL_I2cMasterCallback(I2C_Type *base, i2c_master_handle_t *handle, status_t status,
				  void *callbackParam)
{
...
static void HAL_I2cSlaveCallback(I2C_Type *base, volatile i2c_slave_transfer_t *xfer,
				 void *callbackParam)
{
	...
	if (NULL != i2cSlaveHandle->callback) {
		...
		i2cSlaveHandle->transfer.completionStatus = HAL_I2cGetStatus(
...
hal_i2c_status_t HAL_I2cMasterInit(hal_i2c_master_handle_t handle, const
...
hal_i2c_status_t HAL_I2cSlaveInit(hal_i2c_slave_handle_t handle, const
				  hal_i2c_slave_config_t *config)
{
	hal_i2c_slave_t *i2cSlaveHandle;
					    ...
					    uint32_t			flags)
{
	...
	return HAL_I2cGetStatus(I2C_MasterWriteBlocking(s_i2cBases[i2cMasterHandle->instance],
							txBuff, txSize, flags));
}
					   ...
					   uint32_t			flags)
{
	...
	return HAL_I2cGetStatus(I2C_MasterReadBlocking(s_i2cBases[i2cMasterHandle->instance],
						       rxBuff, rxSize, flags));
}

hal_i2c_status_t HAL_I2cSlaveWriteBlocking(hal_i2c_slave_handle_t handle, const uint8_t *txBuff,
					   size_t txSize)
{
	hal_i2c_slave_t *i2cSlaveHandle;
	...
	return HAL_I2cGetStatus(I2C_SlaveWriteBlocking(s_i2cBases[i2cSlaveHandle->instance], txBuff,
						       txSize));
}

hal_i2c_status_t HAL_I2cSlaveReadBlocking(hal_i2c_slave_handle_t handle, uint8_t *rxBuff, size_t
					  rxSize)
{
	hal_i2c_slave_t *i2cSlaveHandle;
	...
	return HAL_I2cGetStatus(I2C_SlaveReadBlocking(s_i2cBases[i2cSlaveHandle->instance], rxBuff,
						      rxSize));
}
					       ...
					       hal_i2c_master_transfer_t *	xfer)
{
	...
	return HAL_I2cGetStatus(I2C_MasterTransferBlocking(s_i2cBases[i2cMasterHandle->instance],
							   &transfer));
}

hal_i2c_status_t HAL_I2cMasterTransferInstallCallback(hal_i2c_master_handle_t
						      handle,
						      ...
						      callbackParam)
{
	...
	I2C_MasterTransferCreateHandle(s_i2cBases[i2cMasterHandle->instance],
				       &i2cMasterHandle->hardwareHandle,
...
hal_i2c_status_t HAL_I2cMasterTransferGetCount(hal_i2c_master_handle_t handle, size_t *count)
{
	...
	return HAL_I2cGetStatus(
		I2C_MasterTransferGetCount(s_i2cBases[i2cMasterHandle->instance],
					   &i2cMasterHandle->hardwareHandle, count));
}
...
hal_i2c_status_t HAL_I2cMasterTransferAbort(hal_i2c_master_handle_t handle)
{
	...
	i2cMasterHandle = (hal_i2c_master_t *)handle;
	return HAL_I2cGetStatus(
		I2C_MasterTransferAbort(s_i2cBases[i2cMasterHandle->instance],
					&i2cMasterHandle->hardwareHandle));
}
						     ...
						     callbackParam)
{
	...
	I2C_SlaveTransferCreateHandle(s_i2cBases[i2cSlaveHandle->instance],
				      &i2cSlaveHandle->hardwareHandle,
...
hal_i2c_status_t HAL_I2cSlaveTransferNonBlocking(hal_i2c_slave_handle_t handle, uint32_t eventMask)
{
	...
	return HAL_I2cGetStatus(
		I2C_SlaveTransferNonBlocking(s_i2cBases[i2cSlaveHandle->instance],
...
hal_i2c_status_t HAL_I2cSlaveTransferAbort(hal_i2c_slave_handle_t handle)
{
	...
	I2C_SlaveTransferAbort(s_i2cBases[i2cSlaveHandle->instance],
			       &i2cSlaveHandle->hardwareHandle);
...
hal_i2c_status_t HAL_I2cSlaveTransferGetCount(hal_i2c_slave_handle_t handle, size_t *count)
{
	...
	return HAL_I2cGetStatus(
		I2C_SlaveTransferGetCount(s_i2cBases[i2cSlaveHandle->instance],
					  &i2cSlaveHandle->hardwareHandle, count));
}
