...
int main(void)
{
	...
	struct rpmsg_lite_endpoint_callback_data_descr_ns callback_data_ns =
	{ (void *)&has_received, (void *)&msg };
	struct rpmsg_lite_endpoint_callback_descr_ns callback_descr_ns =
	{ (rl_ept_rx_cb_ns_t)my_ept_read_cb_ns,
	  &callback_data_ns };
	char str[50];
	...
	msg.DATA = 1000U;
	struct rpmsg_lite_send_params_ns msg_params = { REMOTE_EPT_ADDR, (char *)&msg,
							sizeof(THE_MESSAGE) };
